...
export interface PluginIcbadScraperInterclubTeam extends Struct.CollectionTypeSchema {
  collectionName: "interclub_teams";
  info: {
    description: "Donn\u00E9es interclubs scrap\u00E9es depuis IcBAD \u2014 classement + rencontres par \u00E9quipe";
    displayName: "Interclub Team";
    pluralName: "interclub-teams";
    singularName: "interclub-team";
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    bonuses: Schema.Attribute.JSON;
    cltoBonusMinus: Schema.Attribute.Integer;
    cltoBonusPlus: Schema.Attribute.Integer;
    cltoDraw: Schema.Attribute.Integer;
    cltoLost: Schema.Attribute.Integer;
    cltoMatchDiff: Schema.Attribute.Integer;
    cltoPlayed: Schema.Attribute.Integer;
    cltoPoints: Schema.Attribute.Integer;
    cltoPosition: Schema.Attribute.Integer;
    cltoPtsDiff: Schema.Attribute.Integer;
    cltoSetDiff: Schema.Attribute.Integer;
    cltoWon: Schema.Attribute.Integer;
    ...
    teamLabel: Schema.Attribute.String & Schema.Attribute.Required;
    teamSlug: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "plugin::icbad-scraper.interclub-team": PluginIcbadScraperInterclubTeam;
