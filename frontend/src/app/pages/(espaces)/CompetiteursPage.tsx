  ...
  return (
    <>
      <Seo
        ...
        description="Espace jeunes compétiteurs du CLTO Badminton Orléans : entraînements, tournois et avantages club."
      />
      <PageHero
        title="JEUNES COMPÉTITEURS"
        subtitle="Saison 2025/2026 — Entraînements, tournois et compétitions jeunes au CLTO Badminton Orléans."
