...
export function ActualitesPage() {
  ...
  const rangeLabel = formatPaginationRange(
    currentPage,
    ARTICLES_PER_PAGE,
    ...
    <>
      ...
      <Section className="bg-white">
        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-8 items-start">
          ...
          <div ref={listRef} className="w-full scroll-mt-24">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 [2000px]:grid-cols-4 gap-8">
              {loading
